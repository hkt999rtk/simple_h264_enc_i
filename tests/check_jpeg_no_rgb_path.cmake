...
if(NOT sh264e_source MATCHES "njDecodeComponents[ \t\r\n]*\\(")
    message(FATAL_ERROR "JPEG encode path must use NanoJPEG component-plane decode")
endif()
...
if(NOT nanojpeg_source MATCHES "decode_components_only")
    message(FATAL_ERROR "NanoJPEG component-only decode guard is missing")
endif()

if(NOT nanojpeg_source MATCHES "if[ \t\r\n]*\\(!nj\\.decode_components_only\\)[ \t\r\n]*njConvert[ \t\r\n]*\\(")
    message(FATAL_ERROR "NanoJPEG component-only decode must skip RGB conversion")
endif()
